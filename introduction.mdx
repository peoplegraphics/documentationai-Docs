...
|-------|-----------|---------|
| **PanelWave Schema** | A JSON Schema (2020-12) that defines the manifest format — the single source of truth for the whole ecosystem. Current format version: **1.5**. | CC BY 4.0 |

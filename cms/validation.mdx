...
| Oversized asset | Images: click **Optimize** on the issue (see [above](#optimizing-oversized-images)). Audio/video, or when you want manual control: re-export the source smaller and use **Replace File** in the [Assets library](/cms/assets) |

---
title: Analytics
description: Read the PanelWave analytics dashboard — reads, completion, reading time, audience breakdowns, the reading funnel, per-panel engagement, the click heatmap, and CSV export.
---
...
The **Click heatmap** shows *where* readers click on a panel — every tap, whether it landed on a [hotspot](/cms/editor/hotspots) or not:

...
Right-clicking the canvas opens a context menu with actions for the current selection — for example adding layers, arranging order, and the Align/Distribute submenus for multi-panel selections. Entries that don't apply to your selection are grayed out.

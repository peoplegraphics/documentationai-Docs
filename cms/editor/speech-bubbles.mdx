...
- Every bubble keeps its **full set of translations**. The canvas, the inline editor, and the Inspector show and edit the text for the editing locale; switching the header locale redraws every bubble in that language at once (this is not an undoable edit and does not mark the work unsaved).

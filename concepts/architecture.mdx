...
Minor versions are additive and ship in-place inside the `1.0/` major-version directory — the current format version is **1.5**, and every valid 1.0 manifest remains valid. See [Versioning](/schema/versioning).

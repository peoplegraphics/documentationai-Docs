...
world-space plane — Scott McCloud's *infinite canvas*. The reader's screen
becomes a camera that glides across the plane along the story graph instead of
swapping panels. A single-column layout yields a webtoon-style vertical strip;

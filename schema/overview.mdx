...
| **Current format version** | `1.5.0` (published in-place in the `1.0/` major-version directory) |
...
| `localization` | `Localization` | — | Since 1.5: translation workflow state (authoring metadata; renderers may ignore). See [Versioning](/schema/versioning#what-changed-in-150) |
